...
function draw() {
    ...
    var player1X = database.ref("players/player1/x");
    player1X.on("value",function(data){
        fighter1.x = data.val();
    })

    var player1Y = database.ref("players/player1/y");
    player1Y.on("value",function(data){
        fighter1.y = data.val();
    })

    var player2X = database.ref("players/player2/x");
    player2X.on("value",function(data){
        fighter2.x = data.val();
    })
    var player2Y = database.ref("players/player2/y");
    player2Y.on("value",function(data){
        fighter2.y = data.val();
    })
    if(players == 1){
        fundo.addImage(wait);
